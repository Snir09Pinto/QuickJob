...
public class OnlineRequestUserViewActivity extends UserViewActivity<OnlineRequest>
{
    /**
    ...
    /**
     *
     * @return view - online request user view.
     */
    @Override
    protected View getView()
    {
        return getLayoutInflater().inflate(R.layout.online_request_user_view_activity_layout, null);
    }
